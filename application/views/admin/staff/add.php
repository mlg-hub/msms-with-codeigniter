 ...
 <div class="container margin-wrap">
        ...
        <div class="row">
         ...
         <div class="col-md-3 sbar br">
          ...
          <div class="col-md-9">
           <?php if($this->session->flashdata('staff_saved')) :?>
           <div class="alert alert-success">
            <?php echo $this->session->flashdata('staff_saved');?>
           </div>
          <?php endif;?>
           <?php echo validation_errors('<div class="alert alert-danger">','</div>');?>
            <h2>Add new <span class="required">staff</span></h2>
            <div class="row">
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6 br">
                    <form role="form" method="post" action="<?php echo base_url();?>admin/staff/add">
                
                        <div class="form-group">
                          <label>Staff firstname<span class="required">*</span></label>
                          <input type="text" name="stfname" class="form-control" placeholder="Name of teacher">
                        </div>
                        <div class="form-group">
                          <label>Staff middle name<span class="required">*</span></label>
                          <input type="text" name="stmname" class="form-control" placeholder="Name of teacher">
                        </div>
                        <div class="form-group">
                          <label>Staff last name<span class="required">*</span></label>
                          <input type="text" name="stlname" class="form-control" placeholder="Name of teacher">
                        </div>
                        <div class="form-group">
                          <input type="hidden" name="sch_id" class="form-control" value="<?php echo $sch_id;?>">
                        </div>
                        <div class="form-group">
                          <label>Staff department(select from the database)<span class="required">*</span></label>
