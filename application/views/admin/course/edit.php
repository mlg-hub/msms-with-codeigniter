...
<div class="container margin-wrap">
        ...
        <div class="row">
         ...
         <form role="form" method="post" action="<?php echo base_url();?>admin/course/edit/<?php echo $cours->id;?>">
         <div class="form-group">
                          <label>Course name<span class="required">*</span></label>
                          <select name="course_list" class="form-control">
                            <option>------select a course------</option>
                            <?php foreach($courses as $course):?>
                              <?php if($course->crs_name == $cours->crs_name) :?>
                                <?php $selected = 'selected';?>
                                 <?php else:?>
                                <?php $selected= '';?>
                              <?php endif;?>
      <option value="<?php echo $course->id_course;?>" <?php echo $selected;?>><?php echo $course->crs_name;?></option>
                          <?php endforeach;?>
                          </select>
                        </div>
                        <div class="form-group">
                         ...
                         <select name="course_cat_max" class="form-control">
                            ...
                            <?php foreach($maxs as $max):?>
                                <?php if($max->max == $cours->max_cat) :?>
                                <?php $selected = 'selected';?>
                                 <?php else:?>
                                <?php $selected= '';?>
                              <?php endif;?>
                      <option value="<?php echo $max->max;?>" <?php echo $selected;?>><?php echo $max->max;?></option>
                          <?php endforeach;?>
                          </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <select name="teacher_id" class="form-control">
                            ...
                            <?php foreach($teachers as $teacher):?>
                                <?php if($teacher->id == $cours->staff_id) :?>
                                <?php $selected = 'selected';?>
                                 <?php else:?>
                                <?php $selected= '';?>
                              <?php endif;?>
    <option value="<?php echo $teacher->id;?>" <?php echo $selected;?>><?php echo $teacher->st_fname;?> <?php echo $teacher->st_mname;?> <?php echo $teacher->st_lname;?> </option>
                          <?php endforeach;?>
                          </select>
                           </div>
                         <div class="form-group">
                          ...
                          <select name="class_id" class="form-control">
                            ...
                            <?php foreach($classes as $class):?>
                                <?php if($class->id== $cours->class_id) :?>
                                <?php $selected = 'selected';?>
                                 <?php else:?>
                                <?php $selected= '';?>
                              <?php endif;?>
