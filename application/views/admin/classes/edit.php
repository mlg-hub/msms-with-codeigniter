              ...
              <div class="col-md-12">
                <div class="row">
                  <div class="col-md-6 br">
                    <form role="form" method="post" action="<?php echo base_url();?>admin/classes/edit/<?php echo $clas->id;?>">
                          ...
                          <label>Class name<span class="required">*</span></label>
                           <select name="class_list" class="form-control">
                            ...
                            <?php foreach($classes as $class):?>
                              <?php if($class->name == $clas->class_name) :?>
                                <?php $selected = 'selected';?>
                                 <?php else:?>
                                <?php $selected= '';?>
                              <?php endif;?>
                            <option value="<?php echo $class->name;?>" <?php echo $selected;?>><?php echo $class->name;?></option>
                          <?php endforeach;?>
                          </select>
                        </div>
                         <div class="form-group">
                          <label>Titulaire teacher name<span class="required">*</span></label>
                           <select name="titu_id" class="form-control">
                            ...
                            <?php foreach($titus as $titu):?>
                             <?php if($titu->id == $clas->titu_id):?>
                                <?php $selected = 'selected';?>
                                 <?php else:?>
                                <?php $selected= '';?>
                              <?php endif;?>
                            <option value="<?php echo $titu->id;?>" <?php echo $selected;?>> <?php echo $titu->st_fname;?> <?php echo $titu->st_mname;?>
