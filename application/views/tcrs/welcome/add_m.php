         ...
         <div class="col-md-3 sbarx br">
          ...
          <div class="col-md-9">
            ...
            <div class="row">
              ...
              <div class="row">
               <?php if(!empty($check_marks->exam_max) || !empty($check_marks->cat_max)):?>
              <form role="form" method="post" action="<?php echo base_url();?>tcrs/welcome/edit_process_m/<?php echo $thestd->id;?>/<?php echo $theclass;?>/<?php echo $subj_id;?>/<?php echo url_title(strtolower($subj_name));?>">
                 <?php else:?>
               <form role="form" method="post" action="<?php echo base_url();?>tcrs/welcome/add_m/<?php echo $thestd->id;?>/<?php echo $theclass;?>/<?php echo $subj_id;?>/<?php echo url_title(strtolower($subj_name));?>">
                 <?php endif;?>
                  <div class="col-md-6">
                 ...
                 <div class="px10 name bt-add">Enter <span class="required">CAT </span>marks:</div>
                  ...
                  <div class="col-md-8 pull-left">
                     <?php if(empty($check_marks->cat_max)):?>
                             <input name="cat_max" type="number" class="form-control"><span class="pull-right"> 
                                   out of: /<?php echo $maxs->max_cat;?></span>
                         <?php else:?>
                             <h4> Records of <span class="required">Cat marks</span> already saved</h4>
                             <input name="cat_max" type="hidden" value="<?php echo $check_marks->cat_max;?>">
                        <?php endif;?>
                ...
                <div class="px10 name bt-add">Enter <span class="required">EXAM</span> marks:</div>
                  <div class="row px10">
                  <div class="col-md-8 pull-left">
                   <?php if(empty($check_marks->exam_max)):?>
                              <input name="exam_max" type="number" class="form-control"><span class="pull-right"> 
                                   out of: /<?php echo $maxs->max_exam;?></span>
                         <?php else:?>
                            <h4> Records of <span class="required">Exam marks</span> already saved</h4>
                            <input type="hidden" name="exam_max" value="<?php echo $check_marks->exam_max;?>">
                        <?php endif;?>
                </div><!-- end col md 6-->
                </div>
             ...
             <?php if(!empty($check_marks->exam_max) || !empty($check_marks->cat_max)):?>
                  ...
                  <input type="hidden" name="per_id" value="<?php echo $check_marks->period_id;?>">
                <?php else:?>
                <div class="bt-add">
                <p><b>Set the teaching period</b></p>
                    <select name="per_id" class="form-control">   
                    <option>--choose a period--</option>
                    <?php foreach($acc_period as $acc_per):?>
                    <option value ="<?php echo $acc_per->id;?>"><?php echo $acc_per->term;?> <?php echo $acc_per->year;?></option>
                    <?php endforeach;?>
